...
| [`search_game_data_text`](mcp-api/tools/search_game_data_text.md) | `cursor?`, `limit?`, `query` | `catalogueRevision`, `nextCursor?`, `query`, `results`, `returned`, `stats`, `total`, `truncated` | Explicitly scan readable Game Data source text for literal matches. |
| [`search_workspace_text`](mcp-api/tools/search_workspace_text.md) | `cursor?`, `limit?`, `query` | `catalogueRevision`, `nextCursor?`, `query`, `results`, `returned`, `stats`, `total`, `truncated` | Explicitly scan workspace source text for literal matches. |
...
| [`inspect_game_data_symbol`](mcp-api/tools/inspect_game_data_symbol.md) | `symbolRef` | `attributes`, `baseType?`, `callableForm?`, `catalogueRevision`, `conditionalContext`, `container?`, `declarationRange`, `defaultValue?`, … | Inspect one exact symbol returned by catalogue search. |
...
| [`read_game_data_source`](mcp-api/tools/read_game_data_source.md) | `catalogueRevision`, `lineCount?`, `relativePath`, `startLine?` | `catalogueRevision`, `content`, `endLine`, `nextStartLine?`, `relativePath`, `startLine`, `truncated` | Read bounded source evidence returned by catalogue tools. |
