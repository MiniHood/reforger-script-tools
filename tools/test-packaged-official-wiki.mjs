...
try {
  ...
  console.log(`Verified ${Object.keys(sourcePages).length} byte-identical packaged Wiki files, 20 concise authoring tools, and independent workspace and Official Wiki workflows.`);
} finally {
