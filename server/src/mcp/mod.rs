...
const WORKBENCH_SEARCH_WORLD_ENTITIES_DESCRIPTION: &str = "Search a bounded page of authored live World Editor entities by text, class, prefab resource, direct component classes, subscene, and layer. Results expose compact component and match facts; use the returned exact entity ID for inspection or mutation.";
