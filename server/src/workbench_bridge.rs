...
pub const BRIDGE_PROJECT_CONTEXT_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchProjectContext.c");
pub const BRIDGE_LOADED_ADDON_GRAPH_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchLoadedAddonGraph.c");
pub const BRIDGE_INSPECT_RESOURCE_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchInspectResource.c");
pub const BRIDGE_WORLD_SELECTION_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchWorldSelection.c");
pub const BRIDGE_SELECTED_ENTITY_HIERARCHY_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchSelectedEntityHierarchy.c");
pub const BRIDGE_ENTITY_LIST_SOURCE: &str = include_str!("../bridge/RST_WorkbenchListEntities.c");
pub const BRIDGE_ENTITY_SEARCH_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchSearchEntities.c");
pub const BRIDGE_LAYER_STATE_SOURCE: &str = include_str!("../bridge/RST_WorkbenchLayerState.c");
pub const BRIDGE_ENTITY_INSPECT_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchInspectEntity.c");
pub const BRIDGE_SET_SELECTION_SOURCE: &str = include_str!("../bridge/RST_WorkbenchSetSelection.c");
pub const BRIDGE_ENTITY_RADIUS_QUERY_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchFindEntitiesByRadius.c");
pub const BRIDGE_TERRAIN_SAMPLE_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchSampleTerrain.c");
pub const BRIDGE_VIEWPORT_CONTEXT_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchViewportContext.c");
pub const BRIDGE_TRACE_SOURCE: &str = include_str!("../bridge/RST_WorkbenchTrace.c");
pub const BRIDGE_CLEAR_SELECTION_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchClearSelection.c");
pub const BRIDGE_ENTITY_MUTATION_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchEntityMutation.c");
...
pub const BRIDGE_SHAPE_GEOMETRY_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchShapeGeometry.c");
...
pub const BRIDGE_LIST_RESOURCES_SOURCE: &str =
    include_str!("../bridge/RST_WorkbenchListResources.c");
