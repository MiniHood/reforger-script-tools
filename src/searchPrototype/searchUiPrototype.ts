...
function render(focusQuery = true) {
  ...
  query.addEventListener('input', event => { state.query = event.target.value; if (state.mode !== 'text') search(true); });
