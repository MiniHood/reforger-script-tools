...
- **[codex-handoff](./codex-handoff/SKILL.md)** — Hand the current conversation off to a fresh Codex background agent that picks up the work immediately, seeded with a handoff summary. User-invoked.
