...
| Wide explicit roster | `sources:both personas:game-api-examples,online-research,language-semantics` | Coordinator retains the source-compatible core and every explicitly requested lens; capacity delays are disclosed and no lens is silently omitted. |
